...
<div class="panel panel-default">
	<div class="panel-heading">Reporte de actuaciones</div>
		<div class="panel-body panel-collapse">
			<?= $vcMsjSrv; ?>
 			<div>
 				<form id="formu" name="<?=$vcFormName?>" ic-post-to="<?=$vcFrmAction?>" ic-target="#listado">
 					<div class="form-group col-lg-10">
            			<label>CDS <span class="aclaracion">(SGA)</span></label>
            			<?=form_dropdown('idCDS', $estructuras, '', 'class="form-control col-lg-4"');?>
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control col-lg-1" id="caratulaActuacion" name="caratulaActuacion" value="" placeholder="Ingrese un criterio de busqueda">
                    </div>
        			<div class="form-group col-lg-2">
