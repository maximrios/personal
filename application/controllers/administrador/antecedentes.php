...
class Antecedentes extends Ext_crud_Controller {
    ...
    public function listado($idAgente = 0) {
        ...
        $editar = '<a href="#" ic-post-to="agentes/formulario/{idAgente}" ic-target="#main_content" title="Editar {nombreCompletoPersona}" class="icono-gridview" rel="{\'idAgente\': {idAgente}}"><span class="glyphicon glyphicon-pencil"></span></a>';
        $baja = '<a href="#" ic-post-to="agentes/baja/{idAgente}" ic-target="#main_content" title="Dar de baja a {nombreCompletoPersona}" class="icono-gridview" rel="{\'idAgente\': {idAgente}}"><span class="glyphicon glyphicon-trash"></span></a>';
        $planilla = '<a href="administrator/agentes/plantilla/{idAgente}" title="Imprimir planilla de {nombreCompletoPersona}" target="_blank" class="icono-gridview" rel="{\'idAgente\': {idAgente}}"><span class="glyphicon glyphicon-print"></span></a>';
        $tamano = '65';
