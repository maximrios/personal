...
class TTF {
    ...
    function __construct() {
	    ...
	    */
	    ...
	    /* Dejavu fonts */
	    FF_UBUNTU => array(
	    	FS_NORMAL =>array('Ubuntu-B.ttf'),
	    	FS_BOLD =>array('Ubuntu-B.ttf','Ubuntu-B.ttf'),
	    	FS_ITALIC =>array('Ubuntu-B.ttf','Ubuntu-B.ttf'),
	    	FS_BOLDITALIC =>array('Ubuntu-B.ttf','Ubuntu-B.ttf') ),
