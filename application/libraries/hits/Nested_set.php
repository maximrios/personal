...
class Nested_set {
	...
	*/
	public function setControlParams($table_name = 'sigep_cursos_materiales', $left_column_name = 'leftCursoMaterial', $right_column_name = 'rightCursoMaterial', $primary_key_column_name = 'idCursoMaterial', $parent_column_name = 'padreCursoMaterial', $text_column_name = 'nombreCursoMaterial') {
...
public function getTreePreorder($node, $direct=false) {
	...
	//$this->db->order_by('fechaCursoMaterial', 'desc');
	//$this->db->order_by('nombreCursoMaterial', 'asc');
...
/**
	...
	* @access private
	*/
	public function updateNameNode($node) {
		$this->db->set($this->text_column_name, $node[$this->text_column_name]);
		$this->db->where($this->primary_key_column_name, (int) $node[$this->primary_key_column_name]);
